...
// It includes endpoint details and session information.
// Used when websocket connection is successfully established.
...
// Used when websocket connection establishment fails.
