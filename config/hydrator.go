...
var (
	...
	// defaultBootstrapInitialQoSDataChecks specifies the number of checks to run immediately after the hydrator starts.
...
type EndpointHydratorConfig struct {
	...
	// BootstrapInitialQoSDataChecks specifies the number of rounds of checks to run immediately after the hydrator starts.
