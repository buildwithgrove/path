...
// The allowlist type for a user's application. Allowlists are optional and can be used to restrict which service requests
// are allowed, using user-defined criteria. Will be one of: contracts, methods, origins, services, user_agent
