...
//
//	mockgen -source=gateway_endpoint_grpc.pb.go -destination=../endpointstore/client_mock_test.go -package=endpointstore -mock_names=GatewayEndpointsClient=MockGatewayEndpointsClient
//
