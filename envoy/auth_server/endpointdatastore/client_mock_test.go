...
//
//	mockgen -source=gateway_endpoint_grpc.pb.go -destination=../endpointdatastore/client_mock_test.go -package=endpointdatastore -mock_names=GatewayEndpointsClient=MockGatewayEndpointsClient
//

// Package endpointdatastore is a generated GoMock package.
