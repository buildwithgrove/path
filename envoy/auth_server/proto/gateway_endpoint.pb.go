...
type AuthDataResponse struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Endpoints     map[string]*GatewayEndpoint `protobuf:"bytes,1,rep,name=endpoints,proto3" json:"endpoints,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Auth struct {
	...
	//	*Auth_StaticApiKey
	//	*Auth_Jwt
	AuthType      isAuth_AuthType `protobuf_oneof:"auth_type"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Auth) GetAuthType() isAuth_AuthType {
	if x != nil {
		return x.AuthType
	}
	return nil
...
func (x *Auth) GetNoAuth() *NoAuth {
	if x != nil {
		if x, ok := x.AuthType.(*Auth_NoAuth); ok {
			return x.NoAuth
		}
	}
	return nil
...
func (x *Auth) GetStaticApiKey() *StaticAPIKey {
	if x != nil {
		if x, ok := x.AuthType.(*Auth_StaticApiKey); ok {
...
func (x *Auth) GetJwt() *JWT {
	if x != nil {
		if x, ok := x.AuthType.(*Auth_Jwt); ok {
			return x.Jwt
		}
	}
	return nil
...
type isAuth_AuthType interface {
	isAuth_AuthType()
}
...
type Auth_StaticApiKey struct {
	...
	StaticApiKey *StaticAPIKey `protobuf:"bytes,2,opt,name=static_api_key,json=staticApiKey,proto3,oneof"`
}
...
func (*Auth_NoAuth) isAuth_AuthType() {}

func (*Auth_StaticApiKey) isAuth_AuthType() {}

func (*Auth_Jwt) isAuth_AuthType() {}
...
type JWT struct {
	...
	AuthorizedUsers map[string]*Empty `protobuf:"bytes,2,rep,name=authorized_users,json=authorizedUsers,proto3" json:"authorized_users,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
var file_envoy_auth_server_proto_gateway_endpoint_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65,
	...
	,
...
var file_envoy_auth_server_proto_gateway_endpoint_proto_depIdxs = []int32{
	...
	7,  // 5: proto.Auth.no_auth:type_name -> proto.NoAuth
	8,  // 6: proto.Auth.static_api_key:type_name -> proto.StaticAPIKey
	9,  // 7: proto.Auth.jwt:type_name -> proto.JWT
	14, // 8: proto.JWT.authorized_users:type_name -> proto.JWT.AuthorizedUsersEntry
	0,  // 9: proto.RateLimiting.capacity_limit_period:type_name -> proto.CapacityLimitPeriod
	5,  // 10: proto.AuthDataResponse.EndpointsEntry.value:type_name -> proto.GatewayEndpoint
	12, // 11: proto.JWT.AuthorizedUsersEntry.value:type_name -> proto.Empty
	1,  // 12: proto.GatewayEndpoints.FetchAuthDataSync:input_type -> proto.AuthDataRequest
	3,  // 13: proto.GatewayEndpoints.StreamAuthDataUpdates:input_type -> proto.AuthDataUpdatesRequest
	2,  // 14: proto.GatewayEndpoints.FetchAuthDataSync:output_type -> proto.AuthDataResponse
	4,  // 15: proto.GatewayEndpoints.StreamAuthDataUpdates:output_type -> proto.AuthDataUpdate
