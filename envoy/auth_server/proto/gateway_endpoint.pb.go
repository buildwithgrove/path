...
const (
	Auth_NO_AUTH      Auth_AuthType = 0
	Auth_API_KEY_AUTH Auth_AuthType = 1
	Auth_JWT_AUTH     Auth_AuthType = 2
)
...
type GatewayEndpoint struct {
	...
	// The metadata for the GatewayEndpoint, which can be set to any additional information
...
func (x *GatewayEndpoint) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *Auth) GetApiKey() string {
	if x, ok := x.GetAuthTypeDetails().(*Auth_ApiKey); ok {
		return x.ApiKey
	}
	return ""
}
...
func (*Auth_ApiKey) isAuth_AuthTypeDetails() {}
...
var file_envoy_auth_server_proto_gateway_endpoint_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x74, 0x65, 0x22, 0x8c, 0x02, 0x0a, 0x0f, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	...
	0x74, 0x69, 0x6e, 0x67, 0x12, 0x40, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x4d,
	...
	,
	...
	0x6a, 0x77, 0x74, 0x22, 0x37, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x0b, 0x0a, 0x07, 0x4e, 0x4f, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c,
	0x41, 0x50, 0x49, 0x5f, 0x4b, 0x45, 0x59, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x10, 0x01, 0x12, 0x0c,
	0x0a, 0x08, 0x4a, 0x57, 0x54, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x10, 0x02, 0x42, 0x13, 0x0a, 0x11,
	0x61, 0x75, 0x74, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c,
	0x73, 0x22, 0xa3, 0x01, 0x0a, 0x03, 0x4a, 0x57, 0x54, 0x12, 0x4a, 0x0a, 0x10, 0x61, 0x75, 0x74,
	...
	,
...
var file_envoy_auth_server_proto_gateway_endpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_envoy_auth_server_proto_gateway_endpoint_proto_goTypes = []any{
	...
	(*JWT)(nil),                    // 8: proto.JWT
	(*RateLimiting)(nil),           // 9: proto.RateLimiting
	(*Empty)(nil),                  // 10: proto.Empty
	nil,                            // 11: proto.AuthDataResponse.EndpointsEntry
	nil,                            // 12: proto.GatewayEndpoint.MetadataEntry
	nil,                            // 13: proto.JWT.AuthorizedUsersEntry
}
var file_envoy_auth_server_proto_gateway_endpoint_proto_depIdxs = []int32{
	11, // 0: proto.AuthDataResponse.endpoints:type_name -> proto.AuthDataResponse.EndpointsEntry
	...
	9,  // 3: proto.GatewayEndpoint.rate_limiting:type_name -> proto.RateLimiting
	12, // 4: proto.GatewayEndpoint.metadata:type_name -> proto.GatewayEndpoint.MetadataEntry
	1,  // 5: proto.Auth.auth_type:type_name -> proto.Auth.AuthType
	10, // 6: proto.Auth.no_auth:type_name -> proto.Empty
	8,  // 7: proto.Auth.jwt:type_name -> proto.JWT
	13, // 8: proto.JWT.authorized_users:type_name -> proto.JWT.AuthorizedUsersEntry
	0,  // 9: proto.RateLimiting.capacity_limit_period:type_name -> proto.CapacityLimitPeriod
	6,  // 10: proto.AuthDataResponse.EndpointsEntry.value:type_name -> proto.GatewayEndpoint
	10, // 11: proto.JWT.AuthorizedUsersEntry.value:type_name -> proto.Empty
	2,  // 12: proto.GatewayEndpoints.FetchAuthDataSync:input_type -> proto.AuthDataRequest
	4,  // 13: proto.GatewayEndpoints.StreamAuthDataUpdates:input_type -> proto.AuthDataUpdatesRequest
	3,  // 14: proto.GatewayEndpoints.FetchAuthDataSync:output_type -> proto.AuthDataResponse
	5,  // 15: proto.GatewayEndpoints.StreamAuthDataUpdates:output_type -> proto.AuthDataUpdate
