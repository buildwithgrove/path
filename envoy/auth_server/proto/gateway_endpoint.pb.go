...
func (m *Auth) GetAuthType() isAuth_AuthType {
	if m != nil {
		return m.AuthType
	}
	return nil
...
func (x *Auth) GetNoAuth() *NoAuth {
	if x, ok := x.GetAuthType().(*Auth_NoAuth); ok {
		return x.NoAuth
	}
	return nil
}
...
func (x *Auth) GetStaticApiKey() *StaticAPIKey {
	if x, ok := x.GetAuthType().(*Auth_StaticApiKey); ok {
...
func (x *Auth) GetJwt() *JWT {
	if x, ok := x.GetAuthType().(*Auth_Jwt); ok {
		return x.Jwt
	}
	return nil
}
