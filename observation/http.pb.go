...
type HTTPRequestObservations struct {
	...
	// request_time stores the time the HTTP request was received.
...
func (x *HTTPRequestObservations) GetRequestTime() *timestamppb.Timestamp {
	if x != nil {
...
var file_path_http_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6c, 0x0a, 0x17, 0x48, 0x54, 0x54, 0x50,
	...
	0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_path_http_proto_depIdxs = []int32{
	1, // 0: path.HTTPRequestObservations.request_time:type_name -> google.protobuf.Timestamp
