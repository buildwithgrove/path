...
type EVMRequestValidationErrorKind int32

const (
	EVMRequestValidationErrorKind_EVM_REQUEST_VALIDATION_ERROR_KIND_UNSPECIFIED                  EVMRequestValidationErrorKind = 0
	EVMRequestValidationErrorKind_EVM_REQUEST_VALIDATION_ERROR_KIND_HTTP_BODY_READ_FAILURE       EVMRequestValidationErrorKind = 1
	EVMRequestValidationErrorKind_EVM_REQUEST_VALIDATION_ERROR_KIND_REQUEST_UNMARSHALING_FAILURE EVMRequestValidationErrorKind = 2
)

// Enum value maps for EVMRequestValidationErrorKind.
var (
	EVMRequestValidationErrorKind_name = map[int32]string{
		0: "EVM_REQUEST_VALIDATION_ERROR_KIND_UNSPECIFIED",
		1: "EVM_REQUEST_VALIDATION_ERROR_KIND_HTTP_BODY_READ_FAILURE",
		2: "EVM_REQUEST_VALIDATION_ERROR_KIND_REQUEST_UNMARSHALING_FAILURE",
	}
	EVMRequestValidationErrorKind_value = map[string]int32{
...
func (x EVMRequestValidationErrorKind) Enum() *EVMRequestValidationErrorKind {
	p := new(EVMRequestValidationErrorKind)
	*p = x
	return p
}

func (x EVMRequestValidationErrorKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EVMRequestValidationErrorKind) Descriptor() protoreflect.EnumDescriptor {
	return file_path_qos_evm_proto_enumTypes[0].Descriptor()
}

func (EVMRequestValidationErrorKind) Type() protoreflect.EnumType {
	return &file_path_qos_evm_proto_enumTypes[0]
}

func (x EVMRequestValidationErrorKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EVMRequestValidationErrorKind.Descriptor instead.
func (EVMRequestValidationErrorKind) EnumDescriptor() ([]byte, []int) {
...
type EVMResponseValidationErrorKind int32

const (
	EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED EVMResponseValidationErrorKind = 0
	EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_EMPTY       EVMResponseValidationErrorKind = 1 // No response data received
	EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNMARSHAL   EVMResponseValidationErrorKind = 2 // Response parsing failed
)

// Enum value maps for EVMResponseValidationErrorKind.
var (
	EVMResponseValidationErrorKind_name = map[int32]string{
		0: "EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED",
		1: "EVM_RESPONSE_VALIDATION_ERROR_KIND_EMPTY",
		2: "EVM_RESPONSE_VALIDATION_ERROR_KIND_UNMARSHAL",
	}
	EVMResponseValidationErrorKind_value = map[string]int32{
		"EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED": 0,
		"EVM_RESPONSE_VALIDATION_ERROR_KIND_EMPTY":       1,
		"EVM_RESPONSE_VALIDATION_ERROR_KIND_UNMARSHAL":   2,
	}
)

func (x EVMResponseValidationErrorKind) Enum() *EVMResponseValidationErrorKind {
	p := new(EVMResponseValidationErrorKind)
	*p = x
	return p
}

func (x EVMResponseValidationErrorKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EVMResponseValidationErrorKind) Descriptor() protoreflect.EnumDescriptor {
	return file_path_qos_evm_proto_enumTypes[1].Descriptor()
}

func (EVMResponseValidationErrorKind) Type() protoreflect.EnumType {
	return &file_path_qos_evm_proto_enumTypes[1]
}

func (x EVMResponseValidationErrorKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EVMResponseValidationErrorKind.Descriptor instead.
func (EVMResponseValidationErrorKind) EnumDescriptor() ([]byte, []int) {
...
type EVMRequestObservations struct {
	...
	RequestValidationErrorKind *EVMRequestValidationErrorKind `protobuf:"varint,4,opt,name=request_validation_error_kind,json=requestValidationErrorKind,proto3,enum=path.qos.EVMRequestValidationErrorKind,oneof" json:"request_validation_error_kind,omitempty"`
}
...
func (x *EVMRequestObservations) GetRequestValidationErrorKind() EVMRequestValidationErrorKind {
	if x != nil && x.RequestValidationErrorKind != nil {
		return *x.RequestValidationErrorKind
	}
	return EVMRequestValidationErrorKind_EVM_REQUEST_VALIDATION_ERROR_KIND_UNSPECIFIED
}
...
type EVMChainIDResponse struct {
	...
	ResponseValidationErrorKind *EVMResponseValidationErrorKind `protobuf:"varint,3,opt,name=response_validation_error_kind,json=responseValidationErrorKind,proto3,enum=path.qos.EVMResponseValidationErrorKind,oneof" json:"response_validation_error_kind,omitempty"`
}
...
func (x *EVMChainIDResponse) GetResponseValidationErrorKind() EVMResponseValidationErrorKind {
	if x != nil && x.ResponseValidationErrorKind != nil {
		return *x.ResponseValidationErrorKind
	}
	return EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED
}
...
func (x *EVMBlockNumberResponse) GetResponseValidationErrorKind() EVMResponseValidationErrorKind {
	if x != nil && x.ResponseValidationErrorKind != nil {
		return *x.ResponseValidationErrorKind
	}
	return EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED
...
func (x *EVMUnrecognizedResponse) GetResponseValidationErrorKind() EVMResponseValidationErrorKind {
	if x != nil && x.ResponseValidationErrorKind != nil {
		return *x.ResponseValidationErrorKind
	}
	return EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED
...
type EVMEmptyResponse struct {
	...
	ResponseValidationErrorKind *EVMResponseValidationErrorKind `protobuf:"varint,2,opt,name=response_validation_error_kind,json=responseValidationErrorKind,proto3,enum=path.qos.EVMResponseValidationErrorKind,oneof" json:"response_validation_error_kind,omitempty"`
}
...
func (x *EVMEmptyResponse) GetResponseValidationErrorKind() EVMResponseValidationErrorKind {
	if x != nil && x.ResponseValidationErrorKind != nil {
		return *x.ResponseValidationErrorKind
	}
	return EVMResponseValidationErrorKind_EVM_RESPONSE_VALIDATION_ERROR_KIND_UNSPECIFIED
...
var file_path_qos_evm_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x02, 0x0a, 0x16, 0x45, 0x56, 0x4d, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	0x68, 0x2f, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x71, 0x6f,
...
var file_path_qos_evm_proto_goTypes = []any{
	(EVMRequestValidationErrorKind)(0),  // 0: path.qos.EVMRequestValidationErrorKind
	(EVMResponseValidationErrorKind)(0), // 1: path.qos.EVMResponseValidationErrorKind
	(*EVMRequestObservations)(nil),      // 2: path.qos.EVMRequestObservations
	(*EVMEndpointObservation)(nil),      // 3: path.qos.EVMEndpointObservation
	(*EVMChainIDResponse)(nil),          // 4: path.qos.EVMChainIDResponse
	(*EVMBlockNumberResponse)(nil),      // 5: path.qos.EVMBlockNumberResponse
	(*EVMUnrecognizedResponse)(nil),     // 6: path.qos.EVMUnrecognizedResponse
	(*EVMEmptyResponse)(nil),            // 7: path.qos.EVMEmptyResponse
	(*JsonRpcRequest)(nil),              // 8: path.qos.JsonRpcRequest
	(*JsonRpcResponse)(nil),             // 9: path.qos.JsonRpcResponse
}
var file_path_qos_evm_proto_depIdxs = []int32{
	8,  // 0: path.qos.EVMRequestObservations.jsonrpc_request:type_name -> path.qos.JsonRpcRequest
	3,  // 1: path.qos.EVMRequestObservations.endpoint_observations:type_name -> path.qos.EVMEndpointObservation
	0,  // 2: path.qos.EVMRequestObservations.request_validation_error_kind:type_name -> path.qos.EVMRequestValidationErrorKind
	4,  // 3: path.qos.EVMEndpointObservation.chain_id_response:type_name -> path.qos.EVMChainIDResponse
	5,  // 4: path.qos.EVMEndpointObservation.block_number_response:type_name -> path.qos.EVMBlockNumberResponse
	6,  // 5: path.qos.EVMEndpointObservation.unrecognized_response:type_name -> path.qos.EVMUnrecognizedResponse
	7,  // 6: path.qos.EVMEndpointObservation.empty_response:type_name -> path.qos.EVMEmptyResponse
	1,  // 7: path.qos.EVMChainIDResponse.response_validation_error_kind:type_name -> path.qos.EVMResponseValidationErrorKind
	1,  // 8: path.qos.EVMBlockNumberResponse.response_validation_error_kind:type_name -> path.qos.EVMResponseValidationErrorKind
	9,  // 9: path.qos.EVMUnrecognizedResponse.jsonrpc_response:type_name -> path.qos.JsonRpcResponse
	1,  // 10: path.qos.EVMUnrecognizedResponse.response_validation_error_kind:type_name -> path.qos.EVMResponseValidationErrorKind
	1,  // 11: path.qos.EVMEmptyResponse.response_validation_error_kind:type_name -> path.qos.EVMResponseValidationErrorKind
