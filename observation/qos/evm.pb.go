...
type EVMGetBalanceResponse struct {
	...
	// The HTTP status code received from the endpoint
	HttpStatusCode int32 `protobuf:"varint,1,opt,name=http_status_code,json=httpStatusCode,proto3" json:"http_status_code,omitempty"`
	// The balance value at the archival block number associated with the contract address specified.
	Balance string `protobuf:"bytes,2,opt,name=balance,proto3" json:"balance,omitempty"`
	// The block number at which the balance was checked.
	// Used to determine whether the get balance request should be used to update archival state.
	BlockNumber string `protobuf:"bytes,3,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`
	// Why the response failed QoS validation
	// If not set, the response is considered valid
	ResponseValidationError *EVMResponseValidationError `protobuf:"varint,4,opt,name=response_validation_error,json=responseValidationError,proto3,enum=path.qos.EVMResponseValidationError,oneof" json:"response_validation_error,omitempty"`
}
...
var file_path_qos_evm_proto_rawDesc = []byte{
	...
	0xa9, 0x04, 0x0a, 0x16, 0x45, 0x56, 0x4d, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x4f,
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x61, 0x74, 0x68, 0x2e, 0x71,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x70, 0x61, 0x74,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x9f, 0x02, 0x0a, 0x15, 0x45, 0x56, 0x4d, 0x47, 0x65, 0x74,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x61, 0x6c,
	...
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x80, 0x01, 0x0a, 0x19, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x70, 0x61, 0x74,
...
func file_path_qos_evm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_path_qos_evm_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*EVMGetBalanceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
