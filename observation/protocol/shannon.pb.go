...
func (x *ShannonDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShannonDetails) ProtoMessage() {}

func (x *ShannonDetails) ProtoReflect() protoreflect.Message {
	mi := &file_path_protocol_shannon_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ShannonDetails.ProtoReflect.Descriptor instead.
func (*ShannonDetails) Descriptor() ([]byte, []int) {
	return file_path_protocol_shannon_proto_rawDescGZIP(), []int{0}
}

func (x *ShannonDetails) GetSupplierAddress() string {
	if x != nil {
...
var file_path_protocol_shannon_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x3b, 0x0a, 0x0e,
	0x53, 0x68, 0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x29,
	0x0a, 0x10, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69,
	0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74,
...
var file_path_protocol_shannon_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_path_protocol_shannon_proto_goTypes = []any{
	(*ShannonDetails)(nil), // 0: path.protocol.ShannonDetails
}
