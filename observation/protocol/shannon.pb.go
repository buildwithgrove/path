...
const file_path_protocol_shannon_proto_rawDesc = "" +
	...
	"\fobservations\x18\x01 \x03(\v2).path.protocol.ShannonRequestObservationsR\fobservations*\xd5\x04\n" +
	...
	";SHANNON_REQUEST_ERROR_INTERNAL_CENTRALIZED_MODE_NO_SESSIONS\x10\x05\x129\n" +
