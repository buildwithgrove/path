...
type ShannonEndpointObservation struct {
	...
	// Latency in seconds between sending the request and receiving the response.
	// Only set if the endpoint did not timeout.
	EndpointRequestLatency float32 `protobuf:"fixed32,17,opt,name=endpoint_request_latency,json=endpointRequestLatency,proto3" json:"endpoint_request_latency,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ShannonEndpointObservation) GetEndpointRequestLatency() float32 {
	if x != nil {
		return x.EndpointRequestLatency
	}
	return 0
}
...
const file_path_protocol_shannon_proto_rawDesc = "" +
	...
	"\x15endpoint_observations\x18\x01 \x03(\v2).path.protocol.ShannonEndpointObservationR\x14endpointObservations\"\xc7\n" +
	"\n" +
	...
	"\x14is_fallback_endpoint\x18\x10 \x01(\bR\x12isFallbackEndpoint\x128\n" +
	"\x18endpoint_request_latency\x18\x11 \x01(\x02R\x16endpointRequestLatencyB\x1e\n" +
