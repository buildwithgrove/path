...
func file_path_protocol_shannon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_path_protocol_shannon_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ShannonObservations); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_path_protocol_shannon_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ShannonObservationsList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
