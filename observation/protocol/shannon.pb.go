...
const (
	...
	ShannonEndpointErrorType_SHANNON_ENDPOINT_ERROR_HTTP_ERROR ShannonEndpointErrorType = 9
)
...
var (
	ShannonEndpointErrorType_name = map[int32]string{
		...
		9: "SHANNON_ENDPOINT_ERROR_HTTP_ERROR",
	}
...
const file_path_protocol_shannon_proto_rawDesc = "" +
	...
	"!SHANNON_ENDPOINT_ERROR_HTTP_ERROR\x10\t*u\n" +
