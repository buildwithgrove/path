...
const (
	...
	// RelayRe
	ShannonEndpointErrorType_SHANNON_ENDPOINT_REQUEST_CANCELLED_BY_PATH ShannonEndpointErrorType = 9
)
...
var (
	ShannonEndpointErrorType_name = map[int32]string{
		...
		9: "SHANNON_ENDPOINT_REQUEST_CANCELLED_BY_PATH",
	}
	ShannonEndpointErrorType_value = map[string]int32{
		...
		"SHANNON_ENDPOINT_REQUEST_CANCELLED_BY_PATH":               9,
	}
)
...
const file_path_protocol_shannon_proto_rawDesc = "" +
	...
	"*SHANNON_ENDPOINT_REQUEST_CANCELLED_BY_PATH\x10\t*\x9b\x01\n" +
