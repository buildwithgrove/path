...
// MorseRequestObservations holds Morse-specific observations gathered through sending
// relay(s) to handle a SINGLE service request.
type MorseRequestObservations struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// app_address is the address of the application on behalf of which the
	// relay(s) associated with the service request was signed.
	// "Gigastake" is a term used in Grove to refer to Morse apps staked for multiple blockchains.
...
func (x *MorseRequestObservations) GetAppAddress() string {
	if x != nil {
		return x.AppAddress
	}
	return ""
...
// MorseObservationsList wraps MorseRequestObservations to enable embedding
// lists of Morse observations in other protobufs.
...
var file_path_protocol_morse_proto_rawDesc = []byte{
	...
	,
...
var file_path_protocol_morse_proto_goTypes = []any{
	(*MorseRequestObservations)(nil), // 0: path.protocol.MorseRequestObservations
	(*MorseObservationsList)(nil),    // 1: path.protocol.MorseObservationsList
}
var file_path_protocol_morse_proto_depIdxs = []int32{
	0, // 0: path.protocol.MorseObservationsList.observations:type_name -> path.protocol.MorseRequestObservations
