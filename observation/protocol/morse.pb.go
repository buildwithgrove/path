...
func (x *MorseDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MorseDetails) ProtoMessage() {}

func (x *MorseDetails) ProtoReflect() protoreflect.Message {
	mi := &file_path_protocol_morse_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use MorseDetails.ProtoReflect.Descriptor instead.
func (*MorseDetails) Descriptor() ([]byte, []int) {
	return file_path_protocol_morse_proto_rawDescGZIP(), []int{0}
}

func (x *MorseDetails) GetGigastakeAppAddress() string {
	if x != nil {
...
var file_path_protocol_morse_proto_rawDesc = []byte{
	...
	0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x42, 0x0a, 0x0c, 0x4d, 0x6f,
	0x72, 0x73, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x67, 0x69,
	0x67, 0x61, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x5f, 0x61, 0x70, 0x70, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x67, 0x69, 0x67, 0x61, 0x73,
	0x74, 0x61, 0x6b, 0x65, 0x41, 0x70, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x35,
...
var file_path_protocol_morse_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_path_protocol_morse_proto_goTypes = []any{
	(*MorseDetails)(nil), // 0: path.protocol.MorseDetails
}
