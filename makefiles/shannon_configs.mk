...
shannon_e2e_config_warning: ## Checks for required Shannon E2E config file
	$(call check_config_exists,./e2e/.shannon.config.yaml,copy_shannon_e2e_config)

.PHONY: copy_shannon_e2e_config
copy_shannon_e2e_config: ## Setup Shannon E2E test configuration file from example template
