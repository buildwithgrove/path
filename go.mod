...
// TODO_IN_THIS_PR(@commoddity): Remove this once the PR is ready.
replace github.com/buildwithgrove/gdi => ../grove-developer-interface

require (
	github.com/buildwithgrove/gdi v0.0.0-20250224094218-d04c68208d28
