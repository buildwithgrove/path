...
func getEndpointCheck(
	...
	requestCtx := requestContext{
		logger:        logger,
		endpointStore: endpointStore,
		// Set the origin of the request as QoS:
		// i.e. the request is generated by the QoS service to collect extra observations on endpoints.
		requestOrigin: qosobservations.RequestOrigin_REQUEST_ORIGIN_QOS,
	}
