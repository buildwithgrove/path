...
func (ss *serviceState) GetRequiredQualityChecks(endpointAddr protocol.EndpointAddr) []gateway.RequestQoSContext {
	...
	// TODO_UPNEXT(@adshmh): Uncomment once the checks have been implemented.
	// return checks
	//
	ss.logger.With("num_checks", len(checks)).Warn().Msg("Skipping checks.")
	return nil
}
...
func (ss *serviceState) getEndpointCheckFromHTTPRequest(httpReq *http.Request) *requestContext {
	return nil
	// TODO_UPNEXT(@adshmh): Uncomment once checks have been implemented.
	//
	/*
